...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Product_Item_Type_r'
        db.create_table('lab_product_item_type_r', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Product_Item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_mgr.Product_Item'])),
            ('Device_Item_Type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_mgr.Device_Item_Type'])),
        ))
        db.send_create_signal(u'lab_mgr', ['Product_Item_Type_r'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Product_Item_Type_r'
        db.delete_table('lab_product_item_type_r')
