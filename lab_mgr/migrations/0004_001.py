...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'lab_platform_hws'
        db.create_table('lab_platform_hws', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('ritType', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('ritName', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('Vendor_unit_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('Vendor_unit_family_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('Vendor_unit_type_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('version_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('serial_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'lab_mgr', ['lab_platform_hws'])


        # Changing field 'lab_device_item.Create_Time'
        db.alter_column('lab_device_item', 'Create_Time', self.gf('django.db.models.fields.DateField')(max_length=50, null=True))

        # Changing field 'lab_device_item.Good_Received_Date'
        db.alter_column('lab_device_item', 'Good_Received_Date', self.gf('django.db.models.fields.DateField')(max_length=50, null=True))

        # Changing field 'lab_device_item.Last_Modify_Time'
        db.alter_column('lab_device_item', 'Last_Modify_Time', self.gf('django.db.models.fields.DateField')(auto_now=True, max_length=50, null=True, auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'lab_platform_hws'
        db.delete_table('lab_platform_hws')


        # Changing field 'lab_device_item.Create_Time'
        db.alter_column('lab_device_item', 'Create_Time', self.gf('django.db.models.fields.DateTimeField')(max_length=50, null=True))

        # Changing field 'lab_device_item.Good_Received_Date'
        db.alter_column('lab_device_item', 'Good_Received_Date', self.gf('django.db.models.fields.DateTimeField')(max_length=50, null=True))

        # Changing field 'lab_device_item.Last_Modify_Time'
        db.alter_column('lab_device_item', 'Last_Modify_Time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, max_length=50, null=True))
    ...
    models = {
        ...
        u'lab_mgr.lab_device_item': {
            ...
            'Last_Modify_Time': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'max_length': '50', 'null': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
